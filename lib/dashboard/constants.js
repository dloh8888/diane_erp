...
/**
 * 국가 표기 통일.
 * 시트마다 표기가 달라서(일별실적은 한글명, 예산·프로모션캘린더는 코드) 그대로 두면
 * 예산 사용율 같은 값이 안 맞습니다. 그래서 전부 두 글자 코드로 맞춥니다.
 * 새로운 표기가 생기면 여기에 한 줄만 추가하면 됩니다.
 */
export const COUNTRY_ALIASES = {
  PH: ['ph', '필리핀', 'philippines', 'philippine'],
  TH: ['th', '태국', 'thailand'],
  MY: ['my', '말레이시아', '말레이시아(서)', '말레이시아(동)', 'malaysia', 'westmalaysia', 'eastmalaysia'],
  VN: ['vn', '베트남', 'vietnam', 'viet nam'],
...
export const COUNTRY_LABELS = {
  PH: '필리핀', TH: '태국', MY: '말레이시아', VN: '베트남', SG: '싱가포르', ID: '인도네시아',
};
